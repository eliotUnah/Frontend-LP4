...
const GoogleLinkPageoscuro = () => {
  ...
  return (
    <div
      style={{
        minHeight: '100vh',
        background: 'linear-gradient(135deg, #1a1a1a 0%, #333 100%)', // Fondo oscuro
        padding: '2rem',
      }}
    >
      <motion.div
        ...
        style={{
          ...
          textAlign: 'center',
          borderRadius: 24,
          background: 'linear-gradient(135deg, #444 0%, #555 100%)', // Fondo del contenedor
...
const purpleBtn = {
  ...
  fontSize: '1.1rem',
  fontWeight: 600,
  backgroundColor: '#9b59b6', // Color de fondo morado
...
export default GoogleLinkPageoscuro;
